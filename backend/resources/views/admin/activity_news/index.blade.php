...
<div class="page-header">
    ...
    <a href="/admin/activity-news/create" class="btn btn-primary add-btn">+ Tambah Berita Kegiatan</a>
</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="/admin/activity-news/{{ $item->activity_news_id }}" class="delete-form"

          ...
          children: [
            IconButton(
              ...
              onPressed: () {
                ...
                final date = publication.releaseDate;
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  DownloadHelper.downloadPublicationPdf(
                    ...
                    fileName: '${publication.title.replaceAll(' ', '_')}.pdf',
                  );
                },
                child: const Text(
                  'Unduh',
  ...
  Widget _buildCover() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: publication.coverUrl != null
            ? DecorationImage(
                image: NetworkImage(
        ...
        child: Column(
          ...
          children: [
            ...
            if (publication.releaseDate != null)
              Text(
                'Dirilis pada tanggal ${publication.releaseDate}',
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              publication.summary ?? 'Tidak ada abstraksi.',
              style: const TextStyle(
                fontSize: 16,
                height: 1.6,
